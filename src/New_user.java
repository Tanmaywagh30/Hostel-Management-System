...
public class New_user implements ActionListener {
	...
	New_user()
	{
	   ...
	   l14.setFont(new Font("Arial",Font.PLAIN,20));
	   
	   l15=new JLabel("Year:");
	   l15.setBounds(780,560,150,30);
	   l15.setFont(new Font("Arial",Font.PLAIN,20));
	   ...
	   t1.setBounds(355,200,150,30);
	   
	   t2=new JTextField(20);
	   t2.setBounds(355,260,150,30);
	   
	   t3=new JTextField(20);
	   t3.setBounds(355,320,150,30);
	   
	   t4=new JTextField(20);
	   t4.setBounds(355,380,150,30);
	   
	   t5=new JTextField(20);
	   t5.setBounds(355,440,150,30);
	   
	   t6=new JTextField(20);
	   t6.setBounds(355,500,150,30);
	   
	   t7=new JTextField(20);
	   t7.setBounds(355,560,150,30);
